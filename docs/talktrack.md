...
- **Four data sources** — VM SKUs, disk SKUs, pricing (17 currencies), and retirement dates
...
- Fetches VM SKUs, disk SKUs, pricing (across 17 currencies), and retirement data
